...
function PostPropertyText() {
  return (
    <>
       <h2 className="fs-5 mt-20" style={{ color: "#424949" }}>
            <strong className=''>Rent or Sell Property Online Easily With NoBroker</strong>
          </h2>
          <p className="pt-3 pb-8" style={{ color: "#787676", lineHeight: "1.35" }}>
          ...
          <p className="pb-6" style={{ color: "#787676", lineHeight: "1.35" }}>
          ...
          <h2
            className="fw-semibold pt-3 pb-3"
          ...
          <h2 className="pt-8 pb-1 fs-5" style={{ color: "#464949" }}>
            <strong>
              How to Sell Property Online With a NoBroker Property Listing{" "}
            </strong>
          </h2>

          <p className='pt-2' style={{ color: "#767979" }}>
          ...
          <h3 className="fs-6 pt-1" style={{ color: "#464949" }}>
            <span>
          ...
          <p className="pt-10 pb-6" style={{ color: "#767979" }}>Here’s how NoBroker ensures that tenants and buyers find your listing:</p>

          <p className="ms-10 mb-1" style={{ color: "#767979" }}><span style={{color: "#464949"}}><strong>1. Potential Tenant/Buyer Views the Listing:</strong></span> Potential tenants or buyers browse NoBroker’s extensive list of property advertisements, filtering by location, price, and property type to find their ideal match.</p>

          <p className="ms-10 mb-1" style={{ color: "#767979" }}><span style={{color: "#464949"}}><strong>2. They Initiate Direct Contact: </strong></span> Once they find a suitable listing, they can click to view more details and obtain contact information.</p>

          <p className="ms-10 pb-7" style={{ color: "#767979" }}><span style={{color: "#464949"}}><strong>3. You Receive Alerts:</strong></span> As soon as someone shows interest, you’ll be notified through multiple channels, including SMS, phone, and WhatsApp, so you never miss a lead.</p>

          <h3 className="fs-6 mb-1" style={{color: "#464949"}}><strong>3. Property Visit and Deal Closure</strong></h3> 

          <p className="mb-10" style={{ color: "#767979" }}>After connecting, the property owner and tenant or buyer can arrange a site visit. NoBroker helps facilitate a smooth deal closure by providing additional services like rental agreement creation and doorstep delivery, painting services, cleaning services, etc. By avoiding middlemen, you get to sell your property or rent out property quickly and efficiently, without any brokerage fees.</p>

          <h3 className="fs-5 pb-6" style={{color: "#464949"}}><strong>Types of Property Listings Available on NoBroker</strong></h3>

          <p style={{ color: "#767979" }}>Here's an overview of the property listings available on NoBroker:</p>

          <h3 className="fs-6 pt-5 pb-5" style={{color: "#464949"}}><strong>1. Residential Properties</strong></h3>
          <p className='pb-5' style={{ color: "#767979" }}>If you are looking to rent out property or sell your house, NoBroker provides a seamless solution. You can easily create a listing for various residential types, including:</p>

          <ul className='ms-12 pb-6' style={{listStyleType: "disc"}}>
        ...
        <h3 className="fs-6 pb-5" style={{color: "#464949"}}><strong>2. Commercial Properties</strong></h3>
          <p className='pb-5' style={{ color: "#767979" }}>Sell or rent your commercial property effortlessly on NoBroker’s platform, designed to accommodate a range of business spaces. Whether it's office space, a co-working setup, a retail shop, a showroom, or even a warehouse, you can easily list your commercial property for sale or rent.</p>

          <h3 className="fs-6 pb-5" style={{color: "#464949"}}><strong>3. Plots</strong></h3>
          <p className='pb-5' style={{ color: "#767979" }}>NoBroker makes it easy for you to sell land online with a user-friendly listing system. When you list your plot, you can include important details like its location, size, shape, and other relevant information.</p>
...
export default PostPropertyText
